...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    switch ($_POST['type']) {
        ...
        case 'reserve':
            ...
            case 'contact_us':
                $company=$pdo->select("SELECT * FROM company_base LIMIT 0,1", 'no', 'one');
                $UserKnowItem=implode('、', $_POST['UserKnowItem']);
                $body_data='<table border="1" cellpadding="10" cellspacing="0">
                                <tbody>
                                <tr>
                                    <td bgcolor="#dadada">名字：</td>
                                ...
                                <tr>
                                    <td bgcolor="#dadada">Line/e-mail：</td>
                                    <td>'.$_POST['UserMail'].'</td>
                                </tr>
                                <tr>
                                    <td bgcolor="#dadada">公司產品內容：</td>
                                    <td>'.$_POST['UserProduct'].'</td>
                                </tr>
                                <tr>
                                    <td bgcolor="#dadada">想了解項目：</td>
                                    <td>'.$UserKnowItem.'</td>
                                </tr>
                                <tr>
                                    <td bgcolor="#dadada">預算區間：</td>
                                    <td>'.$_POST['UserMoney'].'</td>
                                </tr>
                                
                                <tr>
                                    <td bgcolor="#dadada">其他需求：</td>
